...
#dark blue line = 1st + var = ESTEEM1
#briwn line = 1st - var = DEP1
...
print(train_error)
print ('test data MSE')
print(test_error) #less accurate, but close to trianing data
...
print(rsquared_test) #less accurate, but close to trianing data