...
# run following line of code if you get PatsyError 'ImaginaryUnit' object is not callable del I
...
fig4=sm.qqplot(reg3.resid, line='r') #the closer to diagonal line, the more normality it has
