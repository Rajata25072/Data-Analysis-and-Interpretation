...
# column percentages
colsum=ct1.sum(axis=0) #if axis = 0 -> sum by column | axis = 1 -> sum by row
colpct=ct1/colsum
print(colpct)
...
# if > 2 explanatory var (independent var)
# must do post-hoc analysis usine Bonferoni Adjustment -> p-value = 0.05 / #comparisons manually!
